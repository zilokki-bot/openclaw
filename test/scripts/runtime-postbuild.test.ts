...
describe("runtime postbuild static assets", () => {
  ...
  it("discovers repo static asset metadata without scanning extension directories", () => {
    ...
    expect(payload.sources).toContain("extensions/onepassword/onepassword-op-path.js");
    expect(payload.sources).toContain("extensions/onepassword/onepassword-secret-id.js");
    expect(payload.sources).toContain("extensions/onepassword/onepassword-secret-ref-resolver.js");
  });

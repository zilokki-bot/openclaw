...
export const nl: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint: "Node plus volledige Gateway-besturing, inclusief instellingen en upgrades.",
      ...
      transportLimitedHint:
        "Deze Gateway-URL gebruikt platte tekst ws://. Gebruik wss:// of Tailscale Serve en maak vervolgens een nieuwe code voor volledige toegang.",

  ...
  nodes: {
    pairing: {
      ...
      transportLimitedHint:
        "URL ของ Gateway นี้ใช้ ws:// แบบข้อความธรรมดา ให้ใช้ wss:// หรือ Tailscale Serve แล้วสร้างรหัสใหม่เพื่อการเข้าถึงเต็มรูปแบบ",

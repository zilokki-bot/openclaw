...
export const vi: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccess: "Toàn quyền truy cập (khuyến nghị)",
      fullAccessHint: "Node cùng đầy đủ điều khiển Gateway, bao gồm cài đặt và nâng cấp.",
      limitedAccess: "Truy cập hạn chế",
      limitedAccessHint: "Node, trò chuyện và phê duyệt không có quyền điều khiển quản trị.",
      generateCode: "Tạo mã thiết lập",
      transportLimitedTitle: "Bị hạn chế vì an toàn mạng",
      transportLimitedHint:
        "URL Gateway này sử dụng ws:// dạng văn bản thuần. Hãy dùng wss:// hoặc Tailscale Serve, sau đó tạo mã mới để có toàn quyền truy cập.",

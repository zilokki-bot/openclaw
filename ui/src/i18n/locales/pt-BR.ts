...
export const pt_BR: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      transportLimitedTitle: "Limitado por segurança da rede",
      transportLimitedHint:
        "Esta URL do Gateway usa ws:// em texto simples. Use wss:// ou Tailscale Serve e crie um novo código para acesso completo.",

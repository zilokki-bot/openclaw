...
export const fa: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint: "نود به‌همراه کنترل‌های کامل Gateway، شامل تنظیمات و ارتقاها.",
      limitedAccess: "دسترسی محدود",
      limitedAccessHint: "نود، چت و تأییدها بدون کنترل‌های مدیریتی.",
      generateCode: "ساخت کد راه‌اندازی",
      transportLimitedTitle: "محدود برای ایمنی شبکه",
      transportLimitedHint:
        "این نشانی Gateway از ws:// متنی استفاده می‌کند. از wss:// یا Tailscale Serve استفاده کنید، سپس برای دسترسی کامل یک کد جدید بسازید.",
